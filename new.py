...
author = 'KISHOR'
WHATSAPP = 'PRIVATE'
faceb0ok = 'KISHOR SHAHI'
notice = 'ENJOY FREE TOOL'
version = '0.1'
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100088575765028')
###---[ TANGGAL ]---###
...
def login():
	clear_layar()
	print(logo2())
	cookie = input(f"\n [{hh}<{P}]DON'T USE PERSONAL ACCOUNT COOKIE \n cookie : ")
